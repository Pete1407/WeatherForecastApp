...
class ViewModelFactoryModule {
    ...
    @Singleton
    @Provides
    fun provideDetailForecastViewModelFactory(getForecastUseCase: GetForecastUseCase):DetailForecastViewModelFactory{
        return DetailForecastViewModelFactory(getForecastUseCase)
    }
}